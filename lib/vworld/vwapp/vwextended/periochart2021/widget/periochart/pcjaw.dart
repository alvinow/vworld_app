...
class PcJaw extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      children: <Widget>[
        PcCustomJaw(this.pcProperties,this.pcPropertiesOnChangedCallback,this.teethNumberListUpperJaw,PcCustomJaw.upperJawSideFMS),
        Container(
        height: 40,
          child:Row(
            children: [
            ...
            Container(
              ...
              BoxDecoration(border: Border.all(width: 2.0, color: Colors.black)),
                ...
                child:Row(children: [
              Text("Mean Probing Depth =    0 mm",style: textStyleBox1,),
              Text("      Mean Attachment level=   0 mm",style: textStyleBox1,),
              Text("      0% Plaque",style: textStyleBox1,),
              Text("      0% Bleeding on probing",style: textStyleBox1,),

            ],)),
              linerBox1
          ],)
        ),
        PcCustomJaw(this.pcProperties,this.pcPropertiesOnChangedCallback,this.teethNumberListLowerJaw,PcCustomJaw.lowerJawSideFMS),
      ],
    );
  }
}
