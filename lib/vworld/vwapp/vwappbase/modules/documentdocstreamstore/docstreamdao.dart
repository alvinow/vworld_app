...
class DocstreamDao {
  ...
  static Future<int> deleteRecord(String docStreamId) async{
    ...
    try {
      ...
      result = await db.delete(DocumentDatabaseProvider.docstreamTable,where: 'docstream_id=?',whereArgs: <String>[docStreamId]);
    } catch (err) {
  ...
  static Future<int> insertRecord(DocStream docStream) async{
    ...
    try {
      ...
      result = await db.insert(
          DocumentDatabaseProvider.docstreamTable, recordInJson);
    }
    catch(error){
      print(
