...
class Document extends DocumentModel {
  ...
  //begin POT
  static final String documenttypeIdPotOrganization =
      "documenttype_id_pot_organization";
  static final String documenttypeIdPotArticleTransaction =
      "documenttype_id_pot_article_transaction";
  static final String documenttypeIdPotArticleSellPrice =
      "documenttype_id_pot_article_sell_price";
  static final String documenttypeIdPotArticle = "documenttype_id_pot_article";
  //end POT

  static final String documenttypeIdDownsyncDocstreamRequest =
      'documenttype_downsync_docstream_request';
  ...
  static final String upsyncTokenDocumenttypeId =
      'upsync_token_documenttype_id';
  ...
  static final String localfileDocumentLinkDocumenttypeId =
      "local_file_document_link";
  ...
  static final String linkFiledocumenttypegroup =
      '2020_link_filedocumenttypegroup';
  ...
  static final String panitiaMeetingDocumenttypeId =
      'panitia_meeting_documenttype_id';
  ...
  //goodstoreApp
  static final String goodsGoodsstoreAppDocumenttypeId =
      "goodsGoodsstoreAppDocumenttypeId";
  static final String transactionGoodsstoreAppDocumenttypeId =
      "transactionGoodsstoreAppDocumenttypeId";

  //vworld_app -- documenttype_id #begin

  static final String actorDocumenttypeId =
      'meetingmanager_2021_actor_documenttype_id';
  static final String meetingDocumenttypeId =
      'meetingmanager_2021_meeting_document_type_id';
  static final String organizationDocumenttypeId =
      'meetingmanager_2021_organization_documenttype_id';
  static final String personDocumenttypeId =
      'meetingmanager_2021_person_documenttype_id';

  //vworld_app -- documenttype_id #end

  static String getSpmIndukDocumenttypeId(
      {required String thang, required String kdsatker}) {
  ...
  void refreshCreatorJsonSignature() {
    try {
      ...
      print(
          "Error catched on refreshCreatorJsonSignature; ErrorMessage=${error.toString()}");
    }
  }
  ...
  factory Document.fromJsonWithBinaryField(Map<String, dynamic> data,
          {Map<String, dynamic>? docStreamdata}) =>
      Document(
        ...
        binaryUploadBase64: docStreamdata == null
            ? null
            : docStreamdata[Document.binaryUploadBase64_CCFN],
        binaryUploadMd5: docStreamdata == null
            ? null
            : docStreamdata[Document.binaryUploadMd5_CCFN],
        ...
        isLocalClientOnly: data[Document.isLocalClientOnly_CCFN] == null
            ? 0
            : data[Document.isLocalClientOnly_CCFN] is int
                ? data[Document.isLocalClientOnly_CCFN]
                : int.tryParse(data[Document.isLocalClientOnly_CCFN]) == null
                    ? 0
                    : int.tryParse(data[Document.isLocalClientOnly_CCFN]),
  ...
  factory Document.fromJson(Map<String, dynamic> data) =>
      Document.fromJsonWithBinaryField(data);
  /*
